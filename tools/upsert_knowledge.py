...
- **issue**: Bugs, problems, investigations - may resolve over time
...
VERBOSE entries, full context, more is better. Never lose: exact quotes, numbers, names, dates, examples given, caveats stated, and how ideas developed. Summarizing loses information.""",
    inputSchema={
        ...
        "properties": {
            ...
            "category": {"type": "string", "enum": ["reference", "pattern", "table", "command", "issue", "troubleshooting", "project", "decision", "research", "log", "todo", "other"]},
