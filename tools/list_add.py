...
Works for todos, accumulators, or any entry using `- item` format.
Use list_remove to remove items.""",
    inputSchema={
        "type": "object",
        "properties": {
            "id": {"type": "string", "description": "Entry ID (e.g., 'todo-work', 'accumulator-corrections')"},
            ...
            "category": {"type": "string", "description": "Category for new list (default: 'todo')"}
        },
        "required": ["id", "content"]
    }
)
