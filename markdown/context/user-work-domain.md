...
### 1. PDS (Personal Data System) Development (started: ~2023, priority: HIGH)

**Status:** Technical success, organizational failure. Restricted to ODS/Cognos health metrics only.
**Context:** Custom proof-of-concept data platform developed at ~/pds as modern alternative to vendor ODS/Cognos
**Recent progress:** (To be documented as ongoing work progresses)
**Next steps:** Continue restricted use for ODS/Cognos health, personal productivity tool, duckdb-kb integration exploration
**Stakeholders:** Travis Shea (boss), Derek Wormdahl (Travis's boss), team members, other departments

**Details:** See USER.md for recent organizational context. Full technical architecture and organizational history will accumulate here as offloaded from USER.md.
...
- Brock's team: ETL/Banner ODS development (IDR - Integrated Data and Reporting)
- Boss: Travis Shea
- Travis's boss: Derek Wormdahl
- Team: 3 Data Analysts + 1 Data Engineer (Brock)

**Key dynamics:** (Will accumulate here as offloaded from USER.md)
...
**Management:**
- **Travis Shea** - Brock's boss
- **Derek Wormdahl** - Travis's boss, Brock's former boss

**Team members:** (Names to be documented as context emerges)
...
**Languages/Frameworks:** Python, PL/SQL, Pro*C, Java, Groovy/Grails, Gradle, Bash, SQL
**Tools:**
- PDS (Personal Data System) - custom-built at ~/pds
- duckdb-kb - knowledge base system at ~/duckdb-kb
- Ellucian Banner ODS
- Cognos
- Git/BitBucket, Jenkins, AppWorx, DBT, Streamlit, MKDocs, Maven, Eclipse
