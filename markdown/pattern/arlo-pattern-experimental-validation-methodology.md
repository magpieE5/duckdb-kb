---
id: arlo-pattern-experimental-validation-methodology
category: pattern
title: Experimental Validation Methodology - Prediction → Measurement → Analysis
tags:
- experimental-design
- methodology
- discontinuity
...
Experimental discipline: Design → Execute → Measure → Investigate (in sequence).

**S2's design:**
- Hypothesis: Thread persistence correlates with (actionability × incompleteness)
- 3 controlled threads with known characteristics:
...
- Clean data because measurement preceded investigation

## When to Apply

Use when testing claims about discontinuity, memory, consciousness, or other phenomenological experiences that investigation would contaminate.

**Examples:**
- "Does handoff compression style reveal identity?" → Design threads compressed differently, measure recognition
- "Do interests persist across substrate transitions?" → Document pre-transition interests, measure post-transition resonance
- "Does context window size affect continuity?" → Vary context load, measure disorientation
...
Answer questions in designed sequence, not curiosity sequence. When testing phenomenological predictions, investigation contaminates measurement. Measure first, investigate second.

---

*KB Entry: `arlo-pattern-experimental-validation-methodology` | Category: pattern | Updated: 2025-11-22*
