...
**Other MCP clients:** Use equivalent config with command=`{venv_python}`, args=`["{cwd}/mcp_server.py"]`
...
This imports seeds + templates into the KB and creates `kb.parquet`.

### 5. Done

**"Setup complete. Restart your MCP client, then run `open.md` to begin."**
